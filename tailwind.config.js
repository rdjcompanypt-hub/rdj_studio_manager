  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        brand: {
          primary: "var(--color-brand-primary)", /* charcoal */
          secondary: "var(--color-brand-secondary)", /* blue */
          canvas: "var(--color-background-canvas)", /* dark-gray */
        },
        conversion: {
          accent: "var(--color-conversion-accent)", /* teal */
        },
        trust: {
          builder: "var(--color-trust-builder)", /* light-gray */
        },
        cta: "var(--color-cta)", /* orange */
      },
      borderRadius: {
        lg: "var(--radius)",
